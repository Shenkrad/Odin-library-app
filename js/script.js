...
(function render() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        createBookCard(Library.addBookToLibrary(data.book_title, data.book_author, data.book_pages, data.book_read));
    ...
    function removeBook(card) {
        Library.removeBook(card.dataset.id);
        card.remove();
    }

    // a few examples
    Library.addBookToLibrary("The Lord of the Rings", "J.R.R. Tolkien", 1077, true);
    Library.addBookToLibrary("The Final Empire", "Brandon Sanderson", 541, true);
    Library.addBookToLibrary("The Well of Ascension", "Brandon Sanderson", 590, false);
    Library.addBookToLibrary("Foundation", "Isaac Asimov", 255, true);
